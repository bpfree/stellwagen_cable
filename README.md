...
Constructing cables for connection between the wind energy areas and landing sites have a preference for straight trajectories. These routes had to have a 1000m width. In total 7084 straight corridors connected the 77 eastern boundary sites to the 92 western boundary sites. Any lines that crossed a barrier (sites to avoid and Cape Cod boundary limit -- though for the sanctuary, only the sites to avoid existed) did not get considered. That removed 6424 of the 7084 routes, leaving 660. Any lines that exited and re-entered
the sanctuary did not considered either, for an assumption got made that routes needed to remain completely within the sanctuary to get considered. When the 500m buffer got applied to the straight routes, parts of the corridors left the sanctuary site. To remove any routes that left the Sanctuary and re-entered, the analysis split it into two parts. Given the starts and ends of the routes would extend beyond the eastern and western boundary, all good routes would have two parts outside of the sanctuary; but it should not
have more than two. Any corridor consisting of three or more polygons got removed. The second filtering action considered the aggregated area outside the sanctuary. A buffer applied to points should make a circle, making the area outside of the sanctuary about the area of a circle with each side equal to around one half circle. To account for the sanctuary's orientation (a slight northwest to southeast path), the area considered was 50% greater than a full circle. On average each side might get 25% more than the expected
value. With a 500m buffer, the area for any route would be approximately 785,398 meters squared (circle area = pi * r^2 = pi * 500^2 = pi * 250000). After factoring in the potential for additional areas, the maximum area outside the sanctuary was 1,178,097 m^2. With applying this as the maximum area limit, only 516 routes remained for considering between the eastern boundary and western boundary.
