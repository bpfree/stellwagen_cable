...
-   **data**
    ...
    -   **e_least_cost_path_data:** least cost path corridors generated by ArcGIS Pro's tool and final route options for Stellwagen National Marine Sanctuary
...
Any lines that crossed a barrier (sites to avoid and Cape Cod boundary limit -- though for the sanctuary, only the sites to avoid existed) did not get considered. That removed 6424 of the 7084 routes, leaving 660.

###### *Removing routes: leaving sanctuary*
Any lines that exited and re-entered the sanctuary did not considered either, for an assumption got made that routes needed to remain completely within the sanctuary to get considered. When the 500m buffer got applied to the straight routes, parts of the corridors left the sanctuary site. To remove any routes that left the Sanctuary and re-entered, the analysis split it into two parts. Given the starts and ends of the routes would extend beyond the eastern and western boundary, all good routes would have two parts outside of the sanctuary; but it should not
have more than two. Any corridor consisting of three or more polygons got removed.
...
*23 October 2024*
1. [Alice Stratton](mailto:alice.stratton@noaa.gov) and National Marine Sanctuary requested that boulder ridge setback distance get reduced from 500m to 100m and the setback for sites to avoid get reduced from 1000m to 500m. How a 1000m distance was previously chosen remains unclear.

*16 January 2025*
1. [Pete Decola](mailto:pete.decola@noaa.gov) and others desired a cost surface that did not have a submarine cable that goes through the southern portion of the national marine sanctuary. Thus it was removed.
2. During review of the code, it appeared that the eelgrass meadows had a 600m buffer instead of the desired 675m. This got corrected for the cost surface.
